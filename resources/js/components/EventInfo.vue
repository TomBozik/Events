    ...
    <div class="pb-4">
        <div v-if="isAdmin == 1">
            ...
            <div class="flex">
                ...
                <div @click.stop.prevent="copyUrl">
                    <svg class="w-4 h-4 cursor-pointer" version="1.1" viewBox="0 0 512 512"  xmlns="http://www.w3.org/2000/svg">	
    ...
    export default {
        ...
        data(){
            return {
                ...
                originalEvent: '',
                errors: null,
                // url: 'https://events.tmbo.sk/events/b4b666b8a5ec5b8cbde481c9'
            }
        },
        methods: {
            updateEvent() {
